...
<head>
<meta charset="utf-8">
<title> <?php echo $BRANDS ?> - SLOT DEPOSIT DANA 10K RESMI PAGCOR </title>
<meta name="description"  content="<?php echo $BRANDS ?> adalah sebuah situs judi slot online yang menawarkan kemenangan besar dan promo bonus awal 100 + 100" />
...
<link rel="icon" href="https://i.postimg.cc/J0xfXv31/slot-gacor.webp" type="image/x-icon" />
...
.present b {
    background: linear-gradient(to right, #C7A153 0%, #C7A153 100%);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
  font-weight: 700;
}
.section_btn .btn.btn-default {
    background: linear-gradient(to bottom,#C7A153 5%,#C7A153 100%);
  border: 0 none;
  border-radius: 10px;
...
.table-1 {
  background: linear-gradient(to bottom, #C7A153 0%,#927701 100%);
  border-radius: 30px;
  overflow: hidden;
  position: relative;
  text-align: center;
...
section.price_table_bg:after {
  ...
  width: 100%;
  content: "";
  background: linear-gradient(to bottom, #C7A153 0%,#C7A153 100%);
}
.footer_top {
  margin: 5px 0;
  text-align: center;
...
.footer_bottom.fourth-bg a.backtop {
  background: #C7A153 none repeat scroll 0 0;
					...
					<div class="col-md-2">
						<div class="logo_img">
							<a href="<?php echo $urlPath ?>">
								<amp-img src="https://i.ibb.co/ZBZgcWd/GOLDENSEO.png" width="350" height="100" alt="Slot Pulsa 5000"></amp-img>
							</a>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="col-md-6">
						<div class="present">
							<h1><span><?php echo $BRANDS ?> - SLOT DEPOSIT DANA 10K RESMI PAGCOR</h1> 

							<div class="section_btn">
								<a href="https://uangcepat.lol" 
					...
					<div class="col-md-6">
						<div class="present_img">
							<amp-img src="https://i.ibb.co/XLGskHb/GOLDEN.jpg" width="700" height="600" layout="responsive" alt="Slot Pulsa 5000"></amp-img>
						</div>
                        <h3 class="wp-block-heading">Bermain Slot Deposit 10.000 Dan Nikmati Pengalaman Maxwin</h3>
                        <p><a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> - Slot Online Deposit 10.000 adalah permainan slot online yang dapat dimainkan dengan modal hanya sebesar 10.000. Ini adalah salah satu varian dari permainan slot yang memiliki berbagai tema menarik, fitur bonus, dan peluang untuk menang besar.</p>
					</div>
				</div>
			</div>
		</div>
					...
					<footer class="third-bg">
						...
						<div class="footer_bottom fourth-bg">
							...
							<p>&copy; <a href="<?php echo $urlPath ?>"><?php echo $BRANDS ?></a> .18+ Trusted Server</p>
