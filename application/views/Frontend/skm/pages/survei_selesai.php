<section class="finish my-4 my-md-0">
	<div class="container">
		<div class="row justify-content-md-center flex-column flex-lg-row">
			<div class="col col-md-3">
				...
				<p class="lead">
					Responden anda sangat membantu kami dalam kemajuan layanan untuk kedepannya.
				</p>
				<a class="btn btn-danger me-2" href="<?= base_url('survei') ?>">
			...
			<div class="col col-md-6 order-first order-md-last">
				<img class="w-100" src="<?= base_url('assets/images/bg/bg-finish.svg') ?>" alt="Survei BKPPD">
			</div>
		</div>
	</div>
</section>