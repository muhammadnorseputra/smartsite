<section class="survei-non-asn">
	<div class="py-3 px-2 bg-success bg-gradient text-center">
		<h3 class="text-light">Formulir Survei IKM (ASN Balangan)</h3>
	</div>
	<?php  
			...
			<div class="card-body">
				...
				<div class="row mb-md-4 mb-3">
					<div class="col-md-4">
						...
						<input type="text" name="nipnik" class="form-control form-control-lg" id="nipnik" placeholder="NIP/NIK" data-validation="required, number">
					</div>					
				</div>
