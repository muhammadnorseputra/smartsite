<section class="py3 px3">
	<div class="h3 bold">Pages</div>
</section>
<section class="px3 pb3">
	<?php 
		foreach($pageAll->result() as $b):
	?>
		<div class="flex justify-start items-center align-center mb3">
			...
			<span class="ml3">
				<a href="<?= base_url("amp/page/{$b->slug}") ?>" class="text-decoration-none ampstart-accent">
				<h1 class="h3 caps"><?= ucwords($b->title) ?></h1>
				</a>
			</span>
		</div>
	<?php endforeach; ?>
