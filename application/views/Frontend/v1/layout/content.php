...
<div class="fixed-bottom ml-auto text-center w-5 mb-5 mr-5">
    <button type="button" data-toggle="tooltip" data-placement="left" title="Back to top" class="btn shadow btn-info shadow rounded-circle text-center rounded btn-backtop rippler rippler-inverse"><i class="fas fa-arrow-up px-1 py-2"></i></button>
</div>
