...
<div class="fixed-bottom mx-auto text-center w-5 mb-5">
    <button type="button" title="Back to top" class="btn shadow btn-info shadow rounded-circle text-center rounded btn-backtop rippler rippler-inverse"><i class="fas fa-chevron-up"></i></button>
</div>
