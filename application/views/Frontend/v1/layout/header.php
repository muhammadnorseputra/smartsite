					...
					<div class="modal-content border-0 shadow-lg">
						<div class="modal-body">
							...
							<div id="accordionParent" class="accordion">
								...
								<!-- Accordion -->
								<div id="heading1">
								<a href="<?= base_url($m->link); ?>" data-toggle="collapse" data-target="#collapse-<?= $m->id_menu ?>" aria-expanded="false" aria-controls="collapse-<?= $m->id_menu ?>" class="d-block rounded border border-primary text-white collapsible-link px-2 my-2 py-2"><?= $m->nama_menu; ?> <i class="fas fa-folder float-right text-white"></i></a>
								</div>
								...
								<div id="collapse-<?= $m->id_menu ?>" aria-labelledby="heading1" data-parent="#accordionParent" class="collapse">
									<?php foreach ($submenu as $s) : ?>
										...
										<div id="accordionSub" class="accordion">
											<div id="heading2">
											<a href="<?= base_url($s->link_sub); ?>" data-toggle="collapse" data-target="#collapse-<?= $s->idsub ?>" aria-expanded="false" aria-controls="collapse-<?= $s->idsub ?>" class="d-block bg-secondary rounded border border-primary text-white collapsible-link px-2 my-2 py-2"><?= $s->nama_sub; ?> <i class="fas fa-folder float-right text-white"></i></a>
											</div>
											<div id="collapse-<?= $s->idsub ?>" aria-labelledby="heading2" data-parent="#accordionSub" class="collapse">
												<?php foreach ($this->mf_beranda->sub_submenu($s->idsub) as $ss):?>
													...
													<div id="accordionSubSub" class="accordion ml-2">
														<a href="<?= base_url($ss->link_sub); ?>" data-toggle="collapse" data-target="#collapse-<?= $ss->idsub ?>" aria-expanded="false" aria-controls="collapseFive" class="d-block bg-info rounded border border-primary text-white collapsible-link px-2 my-2 py-2"><?= $ss->nama_sub; ?> <i class="fas fa-folder float-right text-white"></i></a>
														<div id="collapse-<?= $ss->idsub ?>" aria-labelledby="heading3" data-parent="#accordionSubSub" class="collapse">
															<?php foreach ($this->mf_beranda->sub_submenu($ss->idsub) as $sss):?>
																<a href="<?= base_url($sss->link_sub); ?>" class="d-block bg-warning position-relative rounded border border-primary text-white px-2 my-2 py-2 ml-2"><?= $sss->nama_sub; ?></a>
															<?php endforeach; ?>
														</div>
													</div>
													<?php else: ?>
														<a href="<?= base_url($ss->link_sub); ?>" class="d-block bg-info position-relative rounded border border-primary text-white px-2 my-2 py-2 ml-2"><?= $ss->nama_sub; ?></a>
													<?php endif; ?>
												<?php endforeach; ?>
											</div>
										</div>
									<?php else: ?>
										<a href="<?= base_url($s->link_sub); ?>" class="d-block bg-secondary position-relative rounded border border-primary text-white px-2 my-2 py-2"><?= $s->nama_sub; ?></a>
									<?php endif ?>
									<?php endforeach; ?>
								</div>
								<?php 
								...
								?>
								<a href="<?= base_url($m->link); ?>" class="d-block position-relative rounded border border-primary text-white collapsible-link px-2 my-2 py-2"><?= $m->nama_menu; ?></a>
								<?php 
								}
								endforeach;	 
								?>
