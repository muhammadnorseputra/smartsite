<!-- Navbar For Desktop -->
<nav id="navbar" class="navbar fixed-top navbar-expand-sm border-bottom d-none d-md-block d-lg-block py-0">
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			...
			<li class="nav-item text-muted">
				<a class="rounded mr-4 pr-2" href="<?= base_url('beranda'); ?>" data-toggle="tooltip" data-placement="bottom" data-title="Beranda">
			...
			<li class="nav-item text-muted">
				<a href="#" type="button" id="mode-toggler" class="mr-4 pr-2" data-toggle="tooltip" data-placement="bottom" data-title="Tampilan Darkmode"></a>
			</li>
