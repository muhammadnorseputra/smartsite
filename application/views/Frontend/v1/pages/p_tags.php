				...
				<div class="row grid" data-target=".item">
					...
					if ($count > 0) {
						...
						foreach ($posts_by_tag->result() as $posts) :
							...
							$status_bookmark = $this->mf_beranda->get_status_bookmark($this->session->userdata('id'), $posts->id_berita) == 'on' ? 'fas' : 'far';
					if(empty($row->img)):
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
						<div class="item" data-aos-duration="<?= $duration ?>00" data-aos-once="true" data-aos="fade-up" data-aos-delay="50">
							<div class="card mb-3 border-0">
								...
								<div class="card-body">
									<a href="#" class="float-right text-muted"><i onclick="bookmark_toggle(this)" class="<?= $status_bookmark ?> fa-bookmark" data-id-berita="<?= $posts->id_berita ?>" data-id-user="<?= $this->session->userdata('id') ?>"></i></a>
