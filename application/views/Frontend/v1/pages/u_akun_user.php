    ...
    <div class="container">
      <div class="row mt-md-0 mt-3">
        ...
        <div class="col-9 col-md-9 pb-3 pb-md-0">
          <a href="<?= base_url('frontend/v1/users/edit/' . encrypt_url($d->id_user_portal)); ?>" class="btn btn-sm btn-light border float-right mt-1"><i class="fas fa-cog mr-md-2 " aria-hidden="true"></i> <span class="d-none d-md-block">Edit Profile</span></a>
          <h3 class="font-weight-bold"><?= $this->session->userdata('user_portal_log')['nama_lengkap']; ?></h3>
          <?= $this->session->userdata('user_portal_log')['email'] . " " . $cek_verify." ".$cek_role; ?> <br>
          ...
          <div class="d-flex justify-content-between flex-wrap flex-lg-row">
          ...
          <a href="<?= base_url('frontend/v1/banner/new_banner') ?>" class="btn border text-primary btn-default mt-3 p-3"> <i class="fas fa-image my-2 fa-3x" aria-hidden="true"></i> <br> New Banner </a>
