<h4 class="px-3 py-3 border-bottom border-light animated fadeIn">Manajemen Postingan <a href="<?php echo base_url('frontend/v1/post/judul') ?>" title="Buat Postingan Baru" data-toggle="tooltip" class="btn btn-sm btn-primary rounded-circle float-right"><i class="fas fa-plus"></i></a></h4>
