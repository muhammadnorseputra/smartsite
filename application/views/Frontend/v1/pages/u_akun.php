...
<section class="hero">
  <div class="container">
    <div class="row">
    <div class="col-12 col-md-8 my-3 my-md-0 py-md-5">
...
<div class="container bg-white mb-md-0 mb-3">
  <div class="row">
    ...
    <div class="col-md-9 px-md-0 order-first order-md-last bg-white rounded-top">
      <div  id="main-content">
      <div class="alert alert-warning alert-dismissible fade show mb-0 rounded-top mt-3" role="alert">
