...
<img src="<?= files('file_banner/'.$this->mf_beranda->get_banner('BANNER', 'Aside')[4]); ?>" class="rounded img-fluid mx-auto d-block my-3" alt="<?= $this->mf_beranda->get_banner('BANNER', 'Aside')[1]; ?>"> 
