...
?>
<div class="col-xs-12 col-sm-12 col-md-4 bg-white py-md-5 rounded-left">
    <div class="card bg-transparent border-0 rounded">
        <div class="card-body" data-aos="fade" data-aos-once="true">
            <i class="fas fa-users p-4 rounded float-right fa-3x text-info d-inline-block mt-1"></i>
...
<div class="col-xs-6 col-sm-6 col-md-4  bg-white py-md-5">
    <div class="card bg-transparent my-md-0 my-4 border-0 rounded-0 big-card">
        <div class="card-body"  data-aos="fade" data-aos-once="true" align-middle">
            <i class="fas fa-user-tie p-4 float-right fa-3x d-inline-block mt-1 text-danger rounded"></i>
...
<div class="col-xs-6 col-sm-6 col-md-4  bg-white py-md-5 rounded-right">
    <div class="card bg-transparent rounded border-0">
        <div class="card-body" data-aos="fade" data-aos-once="true">
            <i class="far p-4 fa-user-circle float-right fa-3x d-inline-block mt-1 text-success rounded"></i>
