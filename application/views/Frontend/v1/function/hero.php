    ...
    <div class="container">
        <div class="row py-md-5">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-5 py-md-5">
                ...
                <!-- Static halo -->
                <p data-aos="fade-up" data-aos-duration="500" class="lead text-light intro-website text-center text-md-left mt-md-2">Website Resmi Badan Kepegawaian Pendidikan dan Pelatihan Daerah</p>
                ...
                <p class="mt-md-5 text-center text-md-left">
                    <button data-aos="fade-up" data-aos-once="true" data-aos-duration="1200" type="button" onclick="explore()" class="btn shadow-lg rounded btn-light py-3 px-4 text-uppercase">
