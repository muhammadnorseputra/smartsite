...
<div class="container">
    <div class="row d-flex align-items-center">
        <div class="col-md-5 py-3 py-md-5 mt-md-5 order-last order-md-first">
            <div>
                <h2 class="text-dark animated fadeInDown">Portal Web BKPPD Balangan</h2>
                <p class="text-muted lead animated fadeInDown">Selamat Datang Pada Portal Web Resmi BKPPD Kabupaten Balangan</p>
            </div>
            <div class="">
                <a href="#content-page" class="btn btn-info btn-block font-weight-lighter btn-lg animated fadeInDown">Explore <i class="fas fa-arrow-down ml-3"></i></a>
        ...
        <div class="col-md-7 order-first order-md-last py-md-5 mt-md-5">
            <img class="img-fluid animated pulse faster" src="<?php echo base_url('assets/images/bg/bg-hero.svg') ?>" alt="Homepage - Portal Web BKPPD Balangan">
        </div>
    </div>
</div>
</section>