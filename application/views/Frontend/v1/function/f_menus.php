...
<div class="dropdown-menu mt--4" aria-labelledby="dropdownMenuButton">
	...
	<a class="dropdown-item bg-white py-2 px-3" href="<?= base_url('frontend/v1/post/judul') ?>"><i class="fas fa-newspaper mr-2" aria-hidden="true"></i> Buat Postingan</a>
	<a class="dropdown-item  bg-white py-2 px-3" href="<?= base_url('frontend/v1/halaman/halamanstatis/add') ?>"><i class="fas fa-pager mr-2" aria-hidden="true"></i> Buat Halaman</a>
	<?php endif; ?>
	...
	<a class="dropdown-item  bg-white py-2 px-3" href="<?php echo base_url('frontend/v1/users/logout') ?>"><i class="fas fa-sign-out-alt mr-2"></i>  Logout</a>
</div>
