...
<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
	<a class="dropdown-item bg-white my-1 rounded py-2 px-2" href="<?php echo base_url("frontend/v1/users/akun/".$this->session->userdata('user_portal_log')['nama_panggilan'].'/'.encrypt_url($this->session->userdata('user_portal_log')['nohp'])) ?>"><i class="far fa-user mr-2"></i> Profile</a>
	...
	<?php endif; ?>
	<a class="dropdown-item  bg-white my-1 rounded py-2 px-2" href="<?= base_url('frontend/v1/users/edit/'.encrypt_url($this->session->userdata('user_portal_log')['id'])); ?>"><i class="fas fa-cog mr-2" aria-hidden="true"></i> Pengaturan akun</a>
