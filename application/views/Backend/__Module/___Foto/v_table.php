<div class="block-header row m-b-15">
	<h2>
		<i
			class="material-icons pull-left m-r-5 m-b-5 font-40 col-<?= $this->madmin->aktifskin('t_skin', 'Y'); ?>">collections</i>
		Galeri Foto
		<small>My Album Photo</small>
	</h2>
</div>
...
<div class="card card-shadow">
	...
	<a href="<?= site_url('module/c_foto/add?module='.$this->madmin->getmodulebycontroller('c_foto').'&user='.$this->session->userdata('user_access')); ?>">
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 text-center p-t-60 p-b-60 border-dot m-l-15">
			<em class="material-icons">add_a_photo</em> <br>Buat Album & Galeri
		</div>
	</a>
