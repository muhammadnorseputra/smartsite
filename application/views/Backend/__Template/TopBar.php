...
<nav class="navbar">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <!-- <ul class="nav navbar-nav navbar-left m-l-90">
                    <li><a href="javascript:void(0);" class="waves-effect"><i class="material-icons">fullscreen</i></a></li>
                </ul> -->
                ...
                <li class="dropdown">
                    ...
                    <a href="javascript:void(0);" data-usrname="<?= $this->session->userdata('namalengkap') ?>" id="btnLogout" data-href="<?= base_url('login/logout') ?>" class="waves-effect waves-circle"  style="padding:0;">
                            <!-- <i class="material-icons">input</i> -->
                            <img src="<?= site_url('assets/images/users/') ?><?= $this->session->userdata('gravatar') ?>" alt="user" class="img-circle" width="100%">
                        </a>    
                    </li>
