    ...
    public function search() {
          ...
          if($data->num_rows() > 0)
          {
           foreach($data->result() as $row)
           {
            ...
            if($row->type === 'BERITA'):
                if(!empty($row->img)):
                    $img = '<img style="object-fit:cover; width:360px; height:210px;" class="rounded-left lazy" data-src="'.base_url('files/file_berita/'.$row->img).'">';
                else:
                    $img = '<img style="object-fit:cover; width:360px; height:210px;" class="rounded-left lazy" data-src="data:image/jpeg;base64,'.base64_encode( $row->img_blob ).'"/>';
                endif;
            else:
                $img = '<img style="object-fit:cover; width:360px; height:210px;" class="rounded-left lazy" data-src="'.base_url('assets/images/noimage.gif').'">';
            endif; 
