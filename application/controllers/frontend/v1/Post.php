...
class Post extends CI_Controller
{
    ...
    public function detail($slug)
    {
        ...
        $meta_tag = meta_tags(
            $e,
            $title = character_limiter($judul_seo, 60),
            $desc = character_limiter($content, 110),
            $imgUrl = $imgurl,
            $url = curPageURL(),
    ...
    public function judul()
    {
        $data = [
            ...
            'mf_beranda' => $this->mf_beranda->get_identitas(),
            'mf_menu' => $this->mf_beranda->get_menu(),
            'kategori' => $this->postlist->get_all_kategori_with_count_berita()->result()
        ];
    ...
    public function list_photo_terkait()
    {
        ...
        if ($data->num_rows() > 0) :
            ...
            $html = '<div class="col-md-12">
                ...
                <div class="d-block text-center text-secondary mb-2">
