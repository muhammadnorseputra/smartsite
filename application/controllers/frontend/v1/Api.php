...
class Api extends CI_Controller {
	...
	{				
		...
		$google_client->setClientId('363934432580-3khto2391b9imq5jvk332aum5r10q3i6.apps.googleusercontent.com');
		//Set the OAuth 2.0 Client Secret key
		$google_client->setClientSecret('wui2QYXcTepkrueJfuJm8NzO');
		//Set the OAuth 2.0 Redirect URI
		$google_client->setRedirectUri('http://localhost/smartsite/google_auth');
	...
	public function google_client()
	{
		...
		if(empty($this->session->userdata('access_token'))){
		 $login_button = '<a href="'.$google_client->createAuthUrl().'" class="btn btn-lg btn-primary">Login With Google</a>';
		}
		echo $login_button;
	}
}